...
CREATE TABLE `pedido_item` (
  ...
  CONSTRAINT `pedido_item_ibfk_1` FOREIGN KEY (`nr_pedido`) REFERENCES `pedido` (`nr_pedido`),
...
INSERT INTO `pedido_item` VALUES (81,1,1,10.00,10.00,67),(81,1,1,10.00,10.00,68),(81,2,1,13.00,13.00,69),(82,2,1,13.00,13.00,70);
